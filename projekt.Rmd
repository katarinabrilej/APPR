...
Najprej sem podatke o notranjih selitvah v Sloveniji predstavila s pomočjo dveh zemljevidev. V prvem zemljevidu so prikazane selitve v določeno regijo statistično regijo Slovenije, v drugem pa selitve iz posamezne regije. Opazimo, da Osrednjeslovenska regija izstopa kako v prvem, tako tudi v drugem zemljevidu.
...
Identične podatke, ki sem jih uporabila za risanje grafov, sem predstavila s spodnjim grafom, ki je sestavljen iz 12 manjših grafov. Vsaki manji graf prikazuje koliko ljudi se je v povprečju izselilo  iz drugih 11 regij in priselilo v regijo, ki je predstavljena v podgrafu katerega opazujemo.
...
Nedvoumno skozi vsa leta se največ ljudi priseli zaradi zaposlitve, nato pa zaradi družitve z družino. Glede na državo predhodnega bivališča, lahko rečemo, da prevladuje Bosna in Hercegovina, potem Srbija in druge države EU. Zaradi boljše preglednosti, število ljudi je predstavljeno kako na x osi, tako tudi z velikostjo posamezne pike.
...
Zaradi nepreglednosti podatkov, sem izhodiščno tabelo, ki je vsebovala 11 starostnih skupin preuredila v tabelo, ki vsebuje samo 3 starostne skupine. 
